...
make PROJECT_BINARY_NAME=../../../bin/client104_linux_amd64 TARGET=LINUX-X64
make PROJECT_BINARY_NAME=../../../bin/client104_linux_arm TARGET=LINUX-ARM
make PROJECT_BINARY_NAME=../../../bin/client104_linux_arm64 TARGET=LINUX-ARM64
make PROJECT_BINARY_NAME=../../../bin/client104_windows_amd64.exe TARGET=WIN64
